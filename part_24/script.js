...
//     fetch('http://www.omdbapi.com/?apikey=b3ccd5f9&s=' + inputKeyword.value)
...
//                 fetch('http://www.omdbapi.com/?apikey=b3ccd5f9&i=' + imdbid)
//                 .then(response => response.json())
//                 .then(m => {
//                     const movieDetail = showMovieDetail(m)
...
function getMovies(keyword){
    return fetch('http://www.omdbapi.com/?apikey=b3ccd5f9&s=' + keyword)
    .then(response =>{
...
// event binding => memberikan event ke element yg blm ad tpi pas ada bisa berjalan
...
function getMovieDetail(imdbid){
    return fetch('http://www.omdbapi.com/?apikey=b3ccd5f9&i=' + imdbid)
    .then(response => response.json())
    .then(m => m)
}
